...
public class TestEmpDAO implements TestInterfaceDAO {
	private static final String INSERT_STMT="INSERT INTO employee VALUES(?,?,?,?,?,?)";
	private static final String UPDATE_STMT="UPDATE employee SET ename=?,hiredate=?,salary=?,deptno=?,title=? WHERE empno=?";
	private static final String DELETE_STMT="DELETE employee WHERE empno=?";
	private static final String GET_ONE_STMT="SELECT empno,ename,hiredate,salary,deptno,title FROM employee WHERE empno=?";
	private static final String GET_ALL_STMT="SELECT empno,ename,hiredate,salary,deptno,title FROM employee ORDER BY empno";
	...
	public List<TestEmpVO> getAll() throws SQLException {
		TestEmpVO emp=null;
		List<TestEmpVO>emps=new ArrayList<TestEmpVO>();
